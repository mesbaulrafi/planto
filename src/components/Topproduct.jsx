...
const Topproduct = ({productImg,productTitle,productDesription,productPrice}) => {
  return (
    ...
    <div className="my-5 border-2 border-white/10  p-8 rounded-[151px] bg-white/5 backdrop-blur-[5px] ">
        ...
        <div className="">
            <Images imgSrc={productImg} className={'absolute bottom-[-100px] left-[-60px] h-[700px]'}/>
        </div>
        <div className="py-10">
            ...
            <div className="flex gap-x-8">
                <div className=""><Button btnText={'Explore'}/></div>
                <div className="border-2 p-3.5 rounded-xl cursor-pointer "><IoBagHandleSharp /></div>
            </div>
        </div>
        </div>
    </div>
