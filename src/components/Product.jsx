...
const Product = ({
  ...
  return (
    <div className="">
      <div className="my-50 border-2 border-white/10 p-8 rounded-[45px] bg-white/5 backdrop-blur-[5px] max-w-[450px] h-[630px] flex flex-col justify-end relative [clip-path:polygon(100%_0,100%_100%,0_100%,0_0,50%_5%)]">
        <div className="">
      ...
      <div className="relative">
        <Images imgSrc={productImg} className={"absolute bottom-[530px] left-0 "} />
      </div>
    </div>
  );
};
