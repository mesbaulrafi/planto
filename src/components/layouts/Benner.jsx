            ...
            <div className=" flex justify-between">
              <div className="w-[900px]">
                ...
                <div className="mt-61.5 w-[409px] border-2 border-white/10  py-11 px-9 rounded-[45px] bg-white/5 backdrop-blur-md ">
                  ...
                  <p className="opacity-75 font-light">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt...</p>
                </div>
              </div>
              <div className="w-[400px] relative top-76">
                <Blurdiv className={'pt-50'}>
                  <div className="pl-8 ">
                    <Images imgSrc={Tree1} className={'absolute bottom-23 right-4'}/>
                    <p className="text-2xl font-light opacity-75">Trendy House Plant </p>
                    
                    <p className="opacity-75 text-[38px] my-5">Calathea plant </p>
                    <div className="absolute bottom-25 right-0"><FaAngleRight /></div>
